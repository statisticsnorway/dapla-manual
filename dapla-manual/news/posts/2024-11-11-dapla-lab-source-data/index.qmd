...
Når en bruker skulle aksessere kildedata fra <https://jupyter.dapla.ssb.no/>, så brukte man JIT-applikasjonen for å få midlertidig tilgang. Denne tilnærmingen vil fortsette å fungere inntil det miljøet avvikles til fordel for Dapla Lab. Men på Dapla Lab kan begrunnelse og tidspunkt gis direkte i tjenestekonfigurasjonen. 

## Feil ved manglende begrunnelse

Hvis man prøver å starte en tjeneste som data-admins uten å oppgi en begrunnelse, så vil man få feilmeldingen vist i @fig-dapla-lab-error-no-justification. Feilmeldingen vil forbedres senere.  

![Feilemelding ved manglende begrunnelse i Dapla Lab.](../../../images/dapla-lab-error-no-justification.png){fig-alt="Viser tjenestekonfigurasjonen i Dapla Lab." #fig-dapla-lab-error-no-justification}
