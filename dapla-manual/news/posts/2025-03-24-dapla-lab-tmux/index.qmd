...
tmux operer med konsepter som *session*, *window* og *panes*. Over startet vi en *session* med navnet **minsesjon**. Dette er et komplett arbeidsmiljø hvor man kan ha flere *windows*m og dele de opp i *panes*. 
