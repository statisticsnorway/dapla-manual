...
Å kunne oppgi en vilkårlig URL hadde en lite fordel i og med at det er en veldig fleksibel løsning. Men det har flere ulemper, særlig mtp. forvaltning av metadata over tid. Fordi:

- Man kunne legge inn en URL som har ingenting med Metadata å gjøre. Dette kunne etterhvert blitt forvirrende eller i verste fall farlig hvis man blir lurt til å åpne visse lenker. Nå skal vi kunne garantere at slike lenker sender man kun til kjente systemer.
- Det kan være flere ulike URLer som refererer til en ressurs, f.eks for Klass er det ulike URLer for Nettsiden og APIet. Det er viktig at vi kan kontrollere hvilken er brukt i en viss kontekst.
...
Hvis man har metadata dokumenter liggende med URLer i disse felt så har vi lagt inn funksjonalitet til å oppgradere informasjon, her er det to tilfeller:
...
- Vi kjenner ikke igjen formen.
  - I dette tilfelle endrer vi ikke på URLen
...
Hvis man ikke har URLer i metadata dokumentene sine, er det bare å dokumentere utifra instrusjonene i Datadoc-editor som vanlig.
