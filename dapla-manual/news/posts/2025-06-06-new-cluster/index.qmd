...
Endringen gjennomføres ila av noen minutter, og man kan derfor starte opp en ny tjeneste og fortsette arbeidet noen minutter etter kl 15.00. Du kan verifisere at det er klart for å starte nye tjenester ved å se etter teksten **Test Ny** øverst til venstre i Dapla Lab, slik som vist i @fig-dapla-lab-ny.

![Tekst som angir om brukeren kan starte nye tjenester.](./dapla-lab-ny.png){fig-alt="Alternativtekst" #fig-dapla-lab-ny}
