...
Når man [lager metadata for en ny periode av en statistikk](../../../statistikkere/datadoc-toolbelt.qmd#kopiere-fra-forrige-periode-uten-endringer) så ligger det en antagelse at det er ingen strukturelle endringer i datasettet. Hvis det er det så kan metadataene være feilaktig og det kan være en brudd i Daplas [system for versjonering av datasett](../../../statistikkere/navnestandard.qmd#versjonering-av-datasett).
