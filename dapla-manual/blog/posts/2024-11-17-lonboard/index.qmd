---
title: Lonboard
subtitle: Et raksere kartvisualiseringsbibliotek
categories:
  - Kart
  - Python
author:
...
Lonboard er også bygget med [Anywidget](https://anywidget.dev).
...
Hver gang du skal vise frem et kart med Folium konverteres kartdataene til et format som kalles Geojson, som så sendes ukomprimert fra Jupyter-serven til nettleseren. 
Dette gjør at selve overføringen tar lang tid, og at du fort går tom for minne i nettleseren om du forsøker å vise et landsdekkende datasett, slik som grunnkretser, tettsteder, eller postnummerområder. 
...
Anywidget er nå installert i Jupyter på Dapla Lab, slik at alle kan prøve ut både Lonboard, samt andre pakker som bygger på Anywidget.
Et eksempel på en slik annen pakke er [Vega-altair](https://altair-viz.github.io)

For det som har lyst å prøve ut Longboard på Dapla Lab følger et eksempel med grunnkretser i Innlandet fylke.
