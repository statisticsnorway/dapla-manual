...
subtitle: Python-pakken `fython` lar deg hente ut data fra Fame-databaser for å jobbe med det i Python.
categories:
  - Fame
  - Python
  - Tidsserier
...
Pakken ligger på GitHub og kan installeres derfra. I et [ssb-project](../../../statistikkere/jobbe-med-kode.html#opprett-ssb-project) installerer du ved å kjøre følgende kommando:
