...
subtitle: Hvordan lagre og bruke filbeskrivelsene på lokal lagring.
categories:
  - statistikkbanken
  - python
...
::: {.callout-important}
Utvikling i statbank-pakken til v1.4.0 gjør en del av denne arbeidsflyten unødvendig.
Siden passordet lagres i tjenesten det jobbes i, kan man re-initialisere StatbankClient uten å skrive passord, og dermed hente filbeskrivelsene fra APIet direkte der man måtte trenge det, uten å hente fra .json filer.
Funksjonaliteten som beskrives under blir liggende (og blogginnlegget fjernes dermed ikke), men å lagre filbeskrivelsene til .json lokalt, er ikke lengre anbefalt eller nødvendig.
:::
