...
Her skal vi gå gjennom det du trenger for å få i gang lasting av skjemaer fra Altinn3 til ISEE, steg for steg.

Måten vi gjør det er ved å gå gjennom hvordan prosessen er satt opp for en hagebruksundersøkelsen, så har du et konkret eksempel å se på underveis. 
...
For å sette opp testløpet er det foreløpig nødvendig å kontakte kundeservice for å åpne på tilganger, slik at du kan overføre filer fra altinn-staging, datamottaket hvor skjemaer fra test-altinn / tt02 havner, til prod bøtten din.

Til vanlig så har du kun tilgang til altinn-staging fra test-teamet, som fungerer på Dapla, men siden test-teamet ikke kan overføre filer til bakken så er det ikke mulig å teste innlasting til ISEE med skjemaer fra tt02 uten å gå via prod bøtten ditt. Derfor trenger du at det åpnes for dette.
:::
...
Det er mange detaljer som skal stemme for at dataene som lastes inn skal dukke opp riktig i ISEE. Du må sjekke at kodelister eksisterer for variablene dine, at disse matcher variabelverdiene som kommer fra altinn3 og at eventuelle endringer i altinn3 skjemaet er hensyntatt i skjemavisningen i ISEE. Ved behov kan du opprette nye kodelister som passer altinn3 dataene dine i klass-forvaltning.
