...
Dapla-team kan dele data mellom team via såkalte delt-bøtter. Hvert team kan opprette de delt-bøttene de har behov for, og deretter gi tilgang til grupper i andre team. Opprettelse av bøtter skal følge [retningslinjene som er definert her](https://statistics-norway.atlassian.net/wiki/spaces/DAPLA/pages/3613786151/Deling+av+data+p+Dapla). Søknad om tilgang til data i delt bøtter skal følge [disse retningslinjene](https://statistics-norway.atlassian.net/wiki/spaces/DAPLA/pages/4238737443/Retningslinjer+for+s+knad+om+tilgang+til+delte+data).

Man kan også dele data ved hjelp av automatiseringstjensten [*delomaten*](delomaten.qmd). 

## Konfigurasjon i Dapla Lab

Eksemplene i @fig-dapla-lab-shared-buckets viser hvordan man tilgjengeliggjør bøttene `rollebasen-fnr` og `arbmark-register` fra dapla-teamene `vof` og `arbmark`.
...
- ssb-<teamnavn>-data-delt-ameld-pii-prod
...
Når man har gjort endringer i `shared-buckets.yaml` så gjør man følgende:
