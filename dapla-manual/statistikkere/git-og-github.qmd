...
I SSB versjonhåndterer vi koden vårmed [Git](https://git-scm.com/). Vi bruker [GitHub](https://github.com/) som brukergrensesnitt og applikasjon for versjonshåndtering med git. For å lære seg å bruke disse verktøyene på en god måte er det derfor viktig å forstå forskjellen mellom Git og Github. Helt overordnet er forskjellen følgende:
...
Bortsett fra versjonshåndtering bruker vi Git og GitHub for å samarbeide om å lage og vedlikeholde produksjonssystemene våre. Disse verktøyene gjrø det lett å spore endringer og se over/godkjenne hverandres bidrag. I praksis betyr det at man skriver kode på sitt område for så å sende disse endringene opp til GitHub.
