...
file_path = os.path.abspath('git-og-github.qmd')
...
I dette kapittelet ser vi nærmere på Git og GitHub og hvordan de er implementert i SSB. Selv om [ssb-project](./jobbe-med-kode.qmd#ssb-project) gjør det lettere å forholde seg til Git og GitHub vil vi dette kapittelet forklare nærmere hvordan det funker uten dette hjelpemiddelet.
...
[Les mer om hvordan man lagrer notebooks til rent tekstformat](https://statistics-norway.atlassian.net/wiki/spaces/A700/pages/3567812611/Hvordan+lagre+Jupyter+notebooks+i+rent+tekstformat).
