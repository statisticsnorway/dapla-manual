...
I SSB versjonhåndterer vi koden vårmed [Git](https://git-scm.com/). Vi bruker [GitHub](https://github.com/) som brukergrensesnitt og applikasjon for versjonshåndtering med git. For å lære seg å bruke disse verktøyene på en god måte er det derfor viktig å forstå forskjellen mellom Git og Github.

::: callout-note
## Git vs. GitHub: kort fotalt
...
Bortsett fra versjonshåndtering bruker vi Git og GitHub for å samarbeide om å lage og vedlikeholde produksjonssystemene våre. Disse verktøyene gjør det lett å spore endringer og se over/godkjenne hverandres bidrag. I praksis betyr det at man skriver kode på sitt område for så å sende disse endringene opp til GitHub.
...
Det finnes mange gode ressurser på huset om versjonshåndtering i tillegg til dette kapittelet. Gruppen Kvalitet i Kode og Koding (KVAKK) har skrevet flere veiledninger på confluence, blant annet om [Git anbefalt arbeidsflyt](https://statistics-norway.atlassian.net/wiki/spaces/BEST/pages/3206283277/Hvordan+er+anbefalt+git+arbeidsflyt) eller [hvordan man løser en merge conflict](https://statistics-norway.atlassian.net/wiki/spaces/BEST/pages/2951905285/Hvordan+l+se+en+merge-konflikt). Se hele katalogen til KVAKK om Git og Github ved å gå inn på deres confluence-område: https://statistics-norway.atlassian.net/wiki/spaces/BEST/pages/3006889999/Versjonskontroll+med+Git I tillegg har A200 sitt støtteteam skrevet om hva man bør lære seg og hvordan man går frem for å lære i [confluence-dokumentet Kom i gang med Dapla](https://statistics-norway.atlassian.net/wiki/spaces/AS/pages/3708878851/Kom+i+gang+med+Dapla) (statistics-norway.atlassian.net)

## Git {{< fa brands git-alt >}}

### Hva er Git?

**Git** er en programvare for distribuert versjonshåndtering av filer. Det vil si at den tar vare på historien til koden din. At Git er distribuert betyr at alle som jobber med koden har en kopi av kode hos seg selv. Når man ønsker på dele koden med andre laster man opp koden til et felles kodelager på GitHub kalt repository. Typisk vil Git brukes til å passe på historien til rene tekstfiler, f.-eks .py-filer, men kan også versjonshåndtere bilder og PDFer-

Git er installert på maskinen du jobber på og brukes fra terminalen. Det finnes pek-og-klikk versjoner av **Git**, blant annet i **Jupyterlab** og **RStudio**. Noen situasjoner vil bare kunne løses i terminalen. Av den grunn velger vi her å fokusere på hvordan **Git** fungerer fra terminalen.
