...
I SSB versjonhåndterer vi koden vår med programvaren [Git](https://git-scm.com/) og [GitHub](https://github.com/) som brukergrensesnitt og applikasjon. For å lære seg å bruke disse verktøyene på en god måte er det derfor viktig å forstå forskjellen mellom Git og Github.
...
Når man ønsker å dele koden med andre laster man opp koden til et felles kodelager på GitHub kalt repository (repo). Git versjonshåndterer filene i repoet. Vanligvis versjonshåndteres rene tekstfiler, men git kan også versjoshåndtere bilder og PDFer.
...
![DaplaLab My account: lagre PAT](../images/dapla-lab-my-account.png){#fig-dapla-lab-my-account fig-alt="Skjermbilde av DaplaLab instillinger for Git"}
