...
:::{.callout-tip}
# Det finnes mange flere systemkommandoer!

Utover de som er vist i denne artiklene finnes det en rekke forskjellige ysstemkommandoer man kan foreta seg fra Python og R, for eksempel som [`os.listdir`](https://docs.python.org/3/library/os.html#os.listdir) eller [`list.dirs()](https://stat.ethz.ch/R-manual/R-devel/library/base/html/list.files.html) i R.
