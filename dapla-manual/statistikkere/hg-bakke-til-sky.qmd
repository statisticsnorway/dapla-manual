...
- Dersom du ikke har Team må du [opprette team på dapla](https://manual.dapla.ssb.no/statistikkere/hva-er-dapla-team.html).
</details>
...
- Aktiver rollene **storagetransfer.admin**, **ssb.buckets.list** og **ssb.bucket.write**.^Du må ha data tilgang til kildebøtten, sjekk i [Dapla Ctrl](https://dapla-ctrl.intern.ssb.no/) om du ikke har tilgang til å gi deg selv tilgang kontakt kundeservice.
...
[Mer detaljert beskrivelse finne her](https://manual.dapla.ssb.no/statistikkere/gcc.html)

### Logge inn på dapla

### Skriptet inneholder funksjonene du trenger i ulike celler. 
Du kan bruke monterte bøtter med vs code, da skal mappene vises i systemet og du kan dra og slippe en fil om gangen. Eller så kan du bruke gscfs som kan bruke vanlige linux kommandoer.
```python
    # %%
    import gcsfs
