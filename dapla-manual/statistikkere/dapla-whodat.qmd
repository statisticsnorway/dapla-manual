...
Det finnes ingen universelt beste søkestrategi da søkemetodikken vil variere basert på datagrunnlaget og behov. Derfor har vi lagt inn mye funksjonalitet i dette biblioteket.
...
kunne da ha vært å kjøre et enkelt søk med alle variablene man har tilgjengelig.
...
| index_original_df | Radnummeret i forhold til indeksen i DataFramen (følger df.index). Brukes for å erstatte ugylidge fødselsnummer    |
