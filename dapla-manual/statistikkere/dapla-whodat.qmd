...
| index_original_df | Radnummeret i forhold til indeksen i DataFramen (følger df.index). Brukes for erstatning av ugyldige FNR.    |
| number_of_found_ids  | Hvor mange FNRer som ble funnet på siste søk   |
| unique_response_step_number  | Hvis et unikt FNR ble funnet - hvilket stegnummer (søk) som fant FNRet. Tallet tilsvarer bruk av `with_search_strategy()`, fra første til siste, hvor første kall er `1`. Hvis man ikke finner et unikt FNR, blir dette None.  |
