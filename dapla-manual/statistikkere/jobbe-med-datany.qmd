...
Man må naturligvis også vite filstien når man skal lese inn data, men vi trenger ikke hele filstien! Dapla lab er *bøttemontert* - det vil si at vi kan forenkle filstier til `buckets/{bøttenavn}/{filnavn}` (`gs://ssb-dapla-felles-data-produkt-prod` er ikke lenger nødvendig å ha i filstien). 
...
jsonlite::toJSON(data, file_path)
```
