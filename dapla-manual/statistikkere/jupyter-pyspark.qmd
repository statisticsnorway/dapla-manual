...
**Jupyter-pyspark** er en tjeneste på [Dapla Lab](./dapla-lab.html) som lar brukerne kode i [Jupyterlab](https://docs.jupyter.org/en/latest/). I tjenesten kommer Python, Pyspark og noen vanlige Jupyterlab-extensions ferdig installert. Målgruppen for tjenesten er brukere som skal skrive produksjonskode med Pyspark i Jupyterlab.
...
1. **Start Jupyter-pyspark**:
   ...
   - Når tjenesten er oppe, åpner du en ny eller eksisterende Notebook for å konfigurere PySpark.
