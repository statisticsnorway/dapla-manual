...
Under **Team og tilgangsgruppe** kan brukeren også velge å representere tilgangsgruppen *data-admins* for et team. I de tilfellene er det et krav om brukeren oppgir en skriftlig begrunnelse for hvorfor tilgangen er nødvendig. I tillegg kan de maksimalt aktivere tilgangen i 8 timer. 
...
Under fanen **Ressurser** kan man velge hvor mye CPU og RAM man ønsker i tjenesten, slik som vist i @fig-dapla-lab-resources. Velg så lite som trengs for å gjøre jobben du skal gjøre. Spark tildeles nå automatisk 90% av minnet konfigurert i tjenestekonfigurasjonen.
...
Fra og med den siste oppdateringen trenger du ikke lenger å manuelt angi mengden RAM i PySpark-konfigurasjonen. Tjenesten er nå konfigurert slik at Spark automatisk tildeles 90% av det totale minnet som er definert i tjenestekonfigurasjonen under **Ressurser**.

Dette forenkler oppsettet og sikrer optimal utnyttelse av tilgjengelige ressurser.
