...
Angir variabelens Datadoc-datatype. Utledes automatisk basert på datatype i Parquet-filen som dokumenteres, men kan endres manuelt av den som dokumenterer. Følgende er verdier er tillat:

#### TEKST 
🌐 *STRING*  
Datadoc-datatypen `STRING` utledes automatisk hvis variabelen er lagret som en `BYTE_ARRAY` i Parquet-filen.  

#### HELTALL 
🌐 *INTEGER*  
Datadoc-datatypen `INTEGER` utledes automatisk hvis variabelen er lagret som en `INT32` eller `INT64` i Parquet-filen. 

#### DESIMALTALL
🌐 *FLOAT*  
Datadoc-datatypen `FLOAT` utledes automatisk hvis variabelen er lagret som en `FLOAT` eller `DOUBLE` i Parquet-filen. 
...
#### BOOLSK
🌐 *BOOLEAN*  
Datadoc-datatypen *BOOLEAN* utledes automatisk hvis variabelen er lagret som en *BOOLEAN* i Parquet-filen.   
