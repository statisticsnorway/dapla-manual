...
Før man åpner en tjeneste kan man konfigurere hvor mye ressurser man ønsker, hvilket team man skal representere, om et GitHub-repo skal klones ved oppstart, og mange andre ting. Valgene man gjør kan også lagres slik at man å slipper å gjøre samme jobb senere. @fig-dapla-lab-rstudio-service viser første fane i tjenestekonfigurasjonen for Rstudio.

![Detaljert tjenestekonfigurasjon i Dapla Lab](../images/dalpa-lab-rstudio-service.png){fig-alt="Viser tjenestekonfigurasjonen i Dapla Lab." #fig-dapla-lab-rstudio-service}
...
Siden Jupyter-tjenesten kommer installert med både R- og Python så er det her man velger hvilke versjoner av disse man ønsker. Man kan velge mellom alle tidligere tilbudte kombinasjoner av R og Python. I @fig-dapla-lab-rstudio-service ser vi av navnet `rstudio:r4.4.0` at tjenesten som default vil startes med versjon 4.4.0 av R. Etter hvert som nye versjoner av R kommer kan disse tilgjengeliggjøres i tjenesten, men brukeren kan velge å starte en eldre versjon av tjenesten og R.
