...
Verken Datadok eller Vardok kan brukes på Dapla. Derfor er en ny løsning for dokumentasjon av datasett, Datadoc, allerede implementert på Dapla. En ny løsning for dokumentasjon av variabeldefinisjoner, Vardef, er også implementert. Relevante variabler fra Vardok skal flyttes dit. 

Klass kan derimot brukes fra Dapla, og det er derfor ennå ikke besluttet om og når denne løsningen skal flyttes eller eventuelt implementeres på nytt på Dapla.
