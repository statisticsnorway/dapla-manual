...
For å sikre dokumentasjon av datasett ikke får feil verdier, settes feltene «Inneholder data f.o.m.» og «Inneholder data t.o.m.» på variabelnivå til None når en ny periode opprettes. Brukeren må aktivt spesifisere verdiene for hver variabel, mens datasettnivået automatisk får gyldighetsperioden fra den nye filen. Dette forhindrer at gammel variabelmetadata gir feil informasjon.
:::
