...
Trigging av kilder manuelt kan kun gjøres av *developers* på Dapla Lab. Årsaken til dette er at vi ønsker at alle på teamet skal ha denne muligheten, og siden brukere som er medlem av tilgangsgruppen *data-admins* også kan være medlemmer av gruppen *developers*, så må man logge seg inn som *developers* i Dapla Lab. På Dapla Lab må man representere en av gruppene når man logger seg inn. 
:::
