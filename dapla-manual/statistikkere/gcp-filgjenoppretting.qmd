...
Google Cloud Storage tilbyr objekt versjonering på bøttenivå.
Når den er aktivert, beholdes en historikk med modifikasjoner (overskriv/slett) av objekter for alle objekter i bøtten.

Du kan liste arkiverte versjoner av et objekt, gjenopprette et objekt til en gamle tilstand etter behov. Alle objekter har generasjonsnummer knyttet til seg for å hjelpe deg med å identifisere objektene og utføre sikre lread-modify-delete oppdateringer på dem

Generasjonsnummeret er numerisk og monotont økende, noe som lar deg raskt evaluere versjonsrekkefølgen. 

Når et objekt overskrives eller slettes i en bøtte som har versjonskontroll aktivert, lagres en kopi av objektet automatisk med generasjonsnummer som identifiserer det.

Hvis objektversjonsstyring ikke er aktivert på en bøtte og du laster opp til et eksisterende objekt, overskrives gjeldende versjon i stedet for å opprette en ny versjon.
...
Når brukeren overskriver en fil i bøtte, blir den eksisterende filen noncurrent versjon og den siste filen skal være den aktive versjonen.
