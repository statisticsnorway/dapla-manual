...
For å få tilgang til data i en tjeneste på Dapla Lab, så må brukeren oppgi hvilket team brukeren skal representere i tjenestekonfigurasjonen, samt om de skal fungere som [developers](./hva-er-dapla-team.qmd#developers) eller [data-admins](./hva-er-dapla-team.qmd#data-admins) i teamet^[Foreløpig er det kun mulig å aksessere data som *developers*. *data-admins* kommer til å bli støttet om kort tid.]. Hvis man ikke spesifiserer at man skal representere et team, så åpnes tjenesten uten tilgang til data i bøtter. 
