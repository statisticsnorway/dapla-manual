...
Under fanen **Git** kan man definere brukernavn og e-post for Git, og et personlig tilgangstoken for GitHub. Dette vil deretter kunne brukes i tjenester som brukeren starter i Dapla Lab. Se her for [dokumentasjonen for oppsett av GitHub-bruker og personlig tilgangstoken](./github-oppsett.qmd).
...
::: {.callout-caution}
## Konfigurasjonene er kun lagret lokalt

Lagrede tjenestekonfigurasjoner er kun lagret lokalt i brukerens nettleser. Av den grunn vil disse slettes hvis nettlesingsdata  slettes, eller være borte hvis du bytter nettleser. 
:::
