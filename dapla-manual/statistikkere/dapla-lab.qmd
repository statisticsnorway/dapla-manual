...
Det finnes 3 adskilte miljøer for Dapla Lab: prod, test og dev. @tbl-env-daplalab viser hvilke url-er som gjelder for de ulike miljøene.

| Miljø | Url                                                            |
| ----- | -------------------------------------------------------------- |
| Prod  | <https://lab.dapla.ssb.no/>                                    |
| Test  | <https://lab.dapla-test.ssb.no/>                               |
| Dev   | <https://lab.dapla-dev.ssb.no/>                                |
: Oversikt over miljøer og tilhørende url-er for Dapla Lab. {#tbl-env-daplalab .striped}

Miljøene er knyttet til datatilgang for [prosjektene til Dapla-team](./hva-er-dapla-team.ipynb#ressurser). Hvert Dapla-team kan ha ressurser i prod-, test, eller dev-miljøet sitt. For å få tilgang til ressursene i et av miljøene må de logge seg inn på tilsvarende miljø i Dapla Lab. Det er f.eks. ikke mulig å aksessere prod-data fra test-miljøet i Dapla Lab og omvendt.  
