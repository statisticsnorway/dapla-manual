...
Hvis man har tjenester som trenger å kjøre hele natten, så kan man melde tjenesten uten av pausingen ved å gi tjenestens visningsnavn et suffix med teksten 
` [nosuspend]`, slik som vist i @fig-dapla-lab-nosuspend.

![Eksempel på en tjeneste som ikke blir pauset hver kveld kl. 17.](../images/dapla-lab-nosuspend.png){fig-alt="Alternativtekst" #fig-dapla-lab-nosuspend}
