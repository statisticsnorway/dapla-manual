...
## Eksempelkode
[Noe demokode ligger i repoet](https://github.com/statisticsnorway/dapla-suv-tools/tree/main/demo/prefill), og kan være ett godt utgangspunkt å kopiere og endre fra.
...
@tbl-prefill-ra0678 beskriver feltene som skal forhåndsutfylles. 

| Felt | Forklaring |
| ----------------- |-------------------------------------------------------------------------------------- |
| antallAnsattePrefill | Tekststreng som forhåndsutfyller antall ansatte
| datoPrefill | Tekststreng som forhåndsutfyller dato. 
