...
Målsettingen er at dette rammeverket skal være fleksibelt nok til at du kan tilpasse det til dine egne behov, spare deg mye tid ved å ha store deler av koden ferdig laget til gjenbruk, og at mest mulig av vedlikeholdet skal gjøres sentralt.
...
Målet vårt med å standardisere oppsettet av editeringsapplikasjoner med en felles ramme og lage gjenbrukbare komponenter er ment å redusere personavhengighet og samle mest mulig vedlikeholdsarbeidet på ett sted. I tillegg kan en felles struktur gjøre det enklere å lære av hverandre og utvide med mer felles funksjonalitet.
...
Det viktigste er at dine data struktureres på en måte som passer dine data. Du kan finne et forslag til datastruktur i dokumentasjonen i neste avsnitt og noen moduler forutsetter at dette oppsettet følges, men rammeverket er ikke låst til ett spesifikt oppsett.
...
- Noen skreddersydde tabeller, figurer eller skjermbilder kreves.
...
- behov for skreddersydde og sammensatte moduler
...
Vi har demoer som du kan se på, og som kan kjøres med dapla-felles tilgangen i Dapla lab som alle har. Du kan finne demoene [her](https://github.com/statisticsnorway/demo-ssb-dash-framework.git).
