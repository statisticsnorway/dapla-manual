...
<div style="padding:56.78% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/1196222150?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write; encrypted-media; web-share" referrerpolicy="strict-origin-when-cross-origin" style="position:absolute;top:0;left:0;width:100%;height:100%;" title="Start R in terminal (no sound)"></iframe></div><script src="https://player.vimeo.com/api/player.js"></script>
...
<div style="padding:56.78% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/1196222123?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write; encrypted-media; web-share" referrerpolicy="strict-origin-when-cross-origin" style="position:absolute;top:0;left:0;width:100%;height:100%;" title="Initialize renv (no sound)"></iframe></div><script src="https://player.vimeo.com/api/player.js"></script>
...
Hvis du ikke har det, kan du opprette en ved å velge File > New Project... > Version Control > Git > og lim inn git adressen for å clone ned repoen. Da vil det også kommer en .Rproj fil. Denne kan fint ligger på repoen. Det er lurte å **ikke** clone ned repoen i oppstart av Dapla-tjenesten når du første oppretter R-prosjektet; ellers får du repoen på nytt som en undermappe.
...
I RStudio, pakkene fra din renv-miljøet kan installeres automatiske ved oppstart av en nye Dapla tjeneste. Til å gjøre dette, legger du inn *ssb-fellesr/scripts/startup-rstudio.sh* som Bash-skript (under Avansert - Oppstartsskript).
...
<div style="padding:56.78% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/1196222151?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write; encrypted-media; web-share" referrerpolicy="strict-origin-when-cross-origin" style="position:absolute;top:0;left:0;width:100%;height:100%;" title="Install R packages (no sound)"></iframe></div><script src="https://player.vimeo.com/api/player.js"></script>
...
<div style="padding:56.78% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/1196222125?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write; encrypted-media; web-share" referrerpolicy="strict-origin-when-cross-origin" style="position:absolute;top:0;left:0;width:100%;height:100%;" title="Install SSB packages (no sound)"></iframe></div><script src="https://player.vimeo.com/api/player.js"></script>
...
Hvis prosjektet er opprettet av noen andre, og har blitt delt med deg, kan alle pakkene i prosjektet installeres samtidig. Clone repository og kjør følgende for å installere alle nødvendige pakker:

```{.r}
renv:restore()
```
<div style="padding:56.78% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/1196222170?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write; encrypted-media; web-share" referrerpolicy="strict-origin-when-cross-origin" style="position:absolute;top:0;left:0;width:100%;height:100%;" title="Clone and restore (no sound)"></iframe></div><script src="https://player.vimeo.com/api/player.js"></script>
...
renv::snapshot()
```
<div style="padding:56.78% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/1196222163?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write; encrypted-media; web-share" referrerpolicy="strict-origin-when-cross-origin" style="position:absolute;top:0;left:0;width:100%;height:100%;" title="Upgrade R (no sound)"></iframe></div><script src="https://player.vimeo.com/api/player.js"></script>
...
<div style="padding:56.78% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/1196222140?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write; encrypted-media; web-share" referrerpolicy="strict-origin-when-cross-origin" style="position:absolute;top:0;left:0;width:100%;height:100%;" title="Create .renvignore (no sound)"></iframe></div><script src="https://player.vimeo.com/api/player.js"></script>
...
Installasjonsprosessen for R-pakker på bakken er den samme som på Dapla. Enkelte pakker (som `arrow` og `ROracle`) kan imidlertid være krevende å installere på grunn av avhengigheter til tredjepartsprogramvare.

**arrow**

Hvis du sliter med installering av `arrow` kan du prøve å spesifisere versjonen som skal installeres.

```{.r}
renv::install("arrow@23.0.0")
```

Pakken er ganske stor, så det kan ta noen minutter å installere den.
...
Pakken `ReGenesees` finnes ikke på CRAN, men kun på Github. Ettersom det kun er tillatt å installere pakker på SSB sin Github-side har denne pakken blitt "forket" til SSB sitt område. Pakken kan installeres med renv ved å kjøre følgende kommando i R:
