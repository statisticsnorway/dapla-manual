...
@fig-dapla-ctrl-medlemsdetaljer gir oversikt over hvilke team personen er medlem av, hvor de jobber, stillingstittel, og hvilke delte data de har tilgang til. 
...
#### Teknisk navn
Teamets navn i et maskinvennlig format som bl.a. benyttes i filstier til lagringsbøtter. Det er ikke tillatt med mellomrom og norske tegn (Æ, Ø og Å). Navnet kan ikke overskride 17 tegn. @tbl-teamnavn viser noen visningsnavn og tilhørende tekniske navn som er valgt tidligere.
...
Brukere med rettigheten til å tilgangsstyre et team kan endre eller fjerne medlemmer ved å trykke på **pen**-ikonet i tabellen, slik som vist i @fig-dapla-ctrl-change-member.

![Bilde av Teamvisning som vises for personer i tilgangsgruppen managers.](../images/dapla-ctrl-change-member.png){fig-alt="A drawing of an elephant." #fig-dapla-ctrl-change-member-box}
...
::: {.column width="20%"}
![Bilde av siden for å endre eller fjerne medlemmer.](../images/dapla-ctrl-change-members-box.png){fig-alt="A drawing of an elephant." #fig-dapla-ctrl-change-member-box}
:::
