...
Legger man inn lenke til repo under *Repo* i tjenestekonfigurasjonen vil repoet klones ved oppstart. His jeg for eksempel vil klone repoet for Dapla-manualen ved oppstart skriver jeg `https://github.com/statisticsnorway/dapla-manual.git` i feltet.
