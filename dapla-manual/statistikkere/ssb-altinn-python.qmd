...
Siden det finnes mange ulike måter å bygge et skjema på, og ønske om å holde funskjonene så generiske som mulig uten for mange parametre, så må man i noen tilfeller tilfeller tilpasse lastefilen til ISEE med ekstra steg etter isee_transfom(). xml_transform kan være til hjelp for å se kompleksiteten i et skjema, og så benytte opplysningene i FELTNAVN/LEVEL-kolonnene for å lage spesialtipassede løpenr m.m.
