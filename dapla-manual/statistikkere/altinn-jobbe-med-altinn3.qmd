...
3. Når Dapla-teamet er opprettet, og første skjema er sendt inn, så ber de Team SUV om å gi statistikkteamet tilgang til dataene som har kommet inn fra Altinn 3. I tillegg ber de om at Team SUV gir tilgang til teamets *Transfer Service* instans. ^[Forslag til e-post til Kundeservice etter at teamet er opprettet:  
***Emne**: Tilgang databøtter - team SUV<br>**Navn** på Dapla-team<br>**Skjema** (RA-nummer). Dersom RA-1000A3 - oppgi også Undersøkelsesnummer for Norsamu (SFU)<br>**Miljø** (test eller produksjon)*] Merk at det må gis separate tilganger for data i test- og produksjonsmiljø. 
