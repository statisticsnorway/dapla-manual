...
##### 6.1 Finn repoet på GitHub

##### 6.2 Opprett ny pull request
...
##### 6.5 Merge og slette gren

Når en kollega har godkjent endringene vil *merge*-knappen bli grønn slik bildet nedenfor viser. Etter å ha merget vil man få muligheten til å seltte grenen enkelt ved å trykke på den grå knappen siste figur viser.

**plaCEholder for figurene** Må få PR for denne grenen godkjent og ta skjermbilde*