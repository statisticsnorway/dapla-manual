...
| Algoritme | Algoritmenavn | Nøkkelnavn         | Støtter SID-mapping |
| --------- | ------------- | ------------------ | ------------------- |
| TINK-DAED | DAED          | ssb-common-key-1   | Nei                 |
| TINK-DAED | DAED          | ssb-common-key-2   | Nei                 |
| TINK-FPE  | Papis         | papis-common-key-1 | Ja                  |
| TINK-FPE  | Papis         | papis-common-key-1 | Nei                 |
