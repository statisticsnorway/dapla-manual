...
*dapla-toolbelt-pseudo* støtter skriving av data til minnet eller til bøtte. Det er anbefalt å bruke `to_file()` siden denne skriver både data og metadata til bøtte. 

*dapla-toolbelt-pseudo* støtter skriving til følgende dataformater:
...
I eksemplene under vises hovedsakelig `to_file()`-metoden i eksemplene. 
...
(
    ...
    .with_default_encryption()                     
    .run()                                         
    .to_file("gs://bucket/utdata/de_pseudo_filer.parquet")                                   
)
```
...
(
    ...
    .run()                               
    .to_file("gs://bucket/produkt/papis_fornavn.parquet")                                  
)
```
...
(
    ...
    .with_stable_id()         
    .run()                               
    .to_file("gs://bucket/produkt/papis_fnr.parquet")                                  
)
```
::: {.callout-note}
