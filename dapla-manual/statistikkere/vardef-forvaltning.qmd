...
Se også [python Vardef](vardef-toolbelt.html) eller [modellbeskrivelsen Vardef](vardef.html).
:::
...
Det er enkelte felt som er valgfrie og kan slettes, enten i utkast eller når man lager en ny Patch eller Gyldighetsperiode.

Feltene det gjelder:

- `classification_reference`
- `measurement_type`
- `valid_until` (kan ikke slettes for publiserte variabeldefinisjoner)
- `external_reference_uri`
- `comment`
- `related_variable_definition_uris`

Man sletter de ved å fjerne verdien fra YAML-fila
