...
Fjerde kapittel handler om standarder og beskriver standarder vi må forholde oss til når vi driver statistikkproduksjon på dapla: for eksempel versjonering, mappestrukturer og filnavn. 
...
I sjette kapittel kan du lære om Dapla Lab: vår utforsker og platform for å kjøre og skrive kode, og kommunisere med Google Cloud Platform. I skrivende stund er Dapla Lab i beta.

I syvende kapittel viser vi til datatjenestene som tilbys på Dapla. Under dette kapitlet er det artikler om automatisk kildedataprosessering med [kildomaten](kildomaten.qmd), [pseudonymisering](pseudonymisering.qmd), [dapla-statbank-client](statistikkbanken.qmd) og tilgangsstyring med [Dapla Ctrl](dapla-ctrl.qmd).
