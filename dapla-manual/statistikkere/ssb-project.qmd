...
Kommandoen over oppretter en mappestruktur slik vi så tidligere, men også et ssb-project som heter **stat-testprod** med et GitHub-repo med samme navn. (Se også navnestandard for repoer: Internt dokument - [Anbefalte kvalitetsindikatorer i statistikkproduksjonen](https://ssbno.sharepoint.com/:w:/r/sites/A20-Standardutvalget/_layouts/15/Doc.aspx?sourcedoc=%7B32459635-A4B4-4913-BFFC-E549DC911512%7D&file=2022_4_kvalitetsindikatorer%20su%200922%20v2.docx&action=default&mobileredirect=true&web=1)). 
