...
### Steg 2: Klargjør og flytt data til Dapla!

En av de viktigste delene av å få en statistikk over på Dapla er å jobbe på Dapla. Derfor bør man flytte noe data som man kan bruke til å bygge et produksjonsløp. Samtidig bør man begynne å skape seg en oversikt over hvilke data som i dag finnes på bakken og hvordan disse dataene er organisert. Det vil for mange ta lang tid å få oversikt over eksisterende data og hva/hvordan man skal arkivere men det er lurt å begynne på det helt fra starten
...
Har man avhengigheter på bakken (f.eks en database) kan det gi mening å jobbe prodsonen, men da er det også en mulighet å eksportere og sende over noe data til Dapla.
...
Neste steg er å lage et repository for statistikken du skal jobbe med! Ifølge [navnestandarden](https://manual.dapla.ssb.no/statistikkere/navnestandard.html#mappestruktur) skal reponavnet begynne med *stat-*.
...
### Steg 4: Planlegg overgangen og tegn dagens produksjonssystem
...
#### 3. Gjør det godt kjent med krav og standarder

* Investerer man tid i å standardene og kravene til statistikkproduksjon på Dapla i starten av en overgang vil man unngå hodebry i fremtiden og spare mye tid
