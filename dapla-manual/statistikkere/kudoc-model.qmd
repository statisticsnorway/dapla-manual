...
2b. informasjonselementer for instrument, som bare er aktuelle for en bestemt instrumenttype – f.eks. opplysninger om intervju-modus: CATI | CAPI | CAWI m.m. kun gjelder for instrumenter av type spørreskjema for personer; \ mens RA/RS-skjemanummer (jf. [Kodeliste for RA/RS-nummer (skjema)](https://www.ssb.no/klass/klassifikasjoner/916)) er kun relevant for innsamlinger vha. skjemaer i Altinn; \ osv.  
...
[*Påkrevd for utkast\ *]{style="background-color:#ffd699;"}  
Verdi i denne velges fra listen over tigjengelige [Dapla-team](./hva-er-dapla-team.qmd) fra [Dapla Ctrl](./dapla-ctrl.qmd#teamoversikt). Valget blir styrende for hvilket team sin kildebøtte som data fra innsamlingen skal legges i.
...
[*Påkrevd for utkast\ *]{style="background-color:#ffd699;"}  
Per MVP, er det implemetert tre valgmuligheter:  
...
Verdier som kan velges er de som i feltet [Innkvitteringsfrekvens](#innkvitteringsfrekvens) for innsamling, og med tillegg for: ... | Daglig | Kontinuerllig (dvs. strømming) | Etter behov ("ad hoc")
...
E-post adresse til kontaktersonen hos dataleverandøren

### Intern kontaktperson (navn)

Velges fra listen ovet team-medelmmer i Dapla-teamet som ble angitt på Innsamling-nivå (jf. [Mottakende Dapla-team](#Mottakende-Dapla-team)).
For den valgte personen, blir også e-post adresse vist, avlest fra Dapla Ctrl.
