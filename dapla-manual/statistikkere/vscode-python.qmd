...
**Vscode-python** er en tjeneste på [Dapla Lab](./dapla-lab.html) for utvikling av kode i Python^[**Vscode-python** er [web-versjonen av VS Code](https://github.com/coder/code-server) og er ikke helt identisk med desktop-versjonen av VS Code mange er kjent med. Blant annet er det kun extensions fra [Open VSX Registry](https://open-vsx.org/) som kan installeres.] og R. Tjenesten er spisset mot Python - man kan derfor ikke forvente like god støtte for R-arbeidsflyter som i [RStudio](rstudio.qmd). Målgruppen for tjenesten er brukere som skal skrive produksjonskode.
