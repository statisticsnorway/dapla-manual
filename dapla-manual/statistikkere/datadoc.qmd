...
Datadoc er en tjeneste som tilbyr et grafisk grensesnitt for å dokumentere datasett og variablene som utgjør datasettet. Formålet med tjenesten er å tilby et lett-å-bruke grensesnitt som hovedsakelig vil benyttes første gang man dokumenterer en type datasett.
...
Under Data i konfigurasjonslisten er det en nedtrekksmeny der man kan velge **Team og tilgangsgruppe**. I denne menyen får du listet alle team og tilgangsgrupper du er med i. Listen vises på formen *\<daplateam\>-\<tilgangsgruppe\>*.

@fig-datadoc-config viser tilfellet der det er valgt å representere tilgangsgruppen **developers** i teamet **Dapla Felles**, derav *dapla-felles-developers*. Det er også det som velges som standard hvis man ikke velger noe annet. 
