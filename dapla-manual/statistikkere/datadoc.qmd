...
I tilfelle man åpner en datasett som ikke følger navnestandarden, så får man en advarsel (@fig-aapne-datasett-advarsel). Det er fullt mulig å bruke Datadoc fortsatt for å dokumentere datasettet, det er bare at ikke like mye metadata kan utledes automatisk (TODO: lenke til seksjonen om utledning).
