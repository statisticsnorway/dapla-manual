...
Når man starter en Datadoc-editor-tjeneste så må man på forhånd velge hvilket team og tilgangsgruppe man skal representere, som [forklart i forrige kapittel](./datadoc.qmd#dapla).
...
Når du trykker på _Lagre metadata_ knappen i Datadoc editor så skrives alle metadata til en fil i samme mappe (katalog) som datafilen. Dette er en JSON-fil med nesten samme navn som datafilen. Navnekonvensjonen for metadatafilen er
