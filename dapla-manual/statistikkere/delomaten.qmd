...
| Navn                             | Beskrivelse                                                                                                                                             |
| -------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `with_stable_id`                   | Koder om til **stabil ID** og deretter krypterer med **TINK-FPE** algoritmen (**Papis**-algoritmen).                                                |
| `with_papis_compatible_encryption` | Krypterer direkte med TINK-FPE algoritme (**Papis**-algoritmen).                                                                         |
...
### Livssyklusen til delte filer

En fil som er delt gjennom Delomaten, skal aldri fjernes fra den delte bøtta. Hvis filen inneholdt en stor og avgjørende feil da den først ble skrevet, kan du unntaksvis [kontakte Kundeservice](https://ssb.pureservice.com/#/categories/14/new) og be om at filen slettes med en begrunnelse om hvorfor.
...
Dette feltet er nødvendig ettersom filens metadata ikke blir slettet når en ny utgave blir lastet opp, og Delomaten må holde styr på hva den faktisk har prosessert.
