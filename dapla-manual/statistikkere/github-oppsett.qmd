...
#### Lagre PAT i .netrc-fil {#lagre-pat-netrc}

Hvis du allerede har startet en DaplaLab tjeneste uten å legge til PAT i brukerkonfigurasjonen din kan du gjøre dette i den kjørende tjenesten ved å kjøre følgende fra terminalen i hjemområdet sitt:
...
Om man vil ha automatisk innhenting av PAT og brukernavn i prodsonen/bakkesystemene må man bruke en .netrc-fil.