...
Denne blokken beskriver om feltet er obligatorisk eller valgfritt, gir forklaring og viser eventuelle eksempler.
...
###### Feil intendering
```{.YAML .code}
# Mangler mellomrom mellom nøkkel og verdi
...
###### Mangler tegn 
```{.YAML .code}
# Mangler `:` mellom nøkkel og verdi
short_name"landbak"
```
::: 
