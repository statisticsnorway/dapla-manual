...
#### YAML-fil utfylt utkast på norsk bokmål
```{.YAML .code style="font-size: 0.9em;"}
# --- Variabeldefinisjon mal ---
name:
    nb: |-
...
#### YAML-fil utfylt utkast på alle språk
...
````
#### YAML-fil publisert variabeldefinisjon ny gyldighetsperiode
```{.YAML .code}
# --- Variabeldefinisjon ---
name:
    nb: |-
...
# --- Statusfelt. Verdi 'DRAFT' før publisering. Ikke rediger hvis du oppretter en ny variabeldefinisjon. ---
variable_status: PUBLISERT_INTERNAL
