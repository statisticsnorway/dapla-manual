...
Se også [Vardef Forvaltning](vardef-forvaltning.html) eller [modellbeskrivelsen Vardef](vardef.html).
:::
...
Brukerdokumentasjonen for Vardef er skrevet i *notebooks* som er ferdig installert i tjenesten [Vardef-forvaltning](./vardef-forvaltning.qmd) i [Dapla Lab](./dapla-lab.qmd). Disse *notebooks*-ene inneholder ferdigskrevet kode som bruker **dapla-toolbelt-metadata** og dekker typiske arbeidsoppgaver i Vardef. De kan kjøres direkte av brukeren, uten behov for å skrive egen kode.
