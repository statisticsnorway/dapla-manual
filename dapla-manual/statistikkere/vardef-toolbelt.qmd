...
### YAML-filens struktur

Alle YAML-filer vil ha samme struktur. 
Hvert felt for `variabeldefinisjon` vil ha en blokk med over feltnavnet
med beskrivelse av feltet og 
...
#### Jobbe med flerspråklige Funksjonalitet
