...
Ta kontakt med team **Datafangsttjenester** dersom du har et behov for å bruke Data Collector.

Python-biblioteket [ssb-collector-client](./ssb-collector-client.qmd) kan brukes for å administrere innsamlingsoppgaver (starte, overvåke, stoppe) mot Data Collector.
