...
@fig-dapla-lab-jdemetra-konf-dapla viser hvilke valg man gjøre under menyen **Data**. Først kan man velge om ønsker å aktivere datatilgang. Det vil si om man vil ha tilgang til bøtter fra tjenesten. I de aller fleste tilfeller er dette ønskelig, siden man ikke får lagret noe permanent uten dette.

Hvis man velger datatilgang, så må man deretter spesifisere hvilket team og tilgangsgruppe man ønsker å representere. Alle i SSB er medlem av *developers*-gruppa i teamet [Dapla Felles](./hva-er-dapla-team.qmd#dapla-felles), derfor kan man velge dette teamet hvis man ønsker teste ut tjenesten.
...
![Detaljert tjenestekonfigurasjon i JDemetra-tjenesten: versjon](../images/dapla-lab-jdemetra-konf-service.png){fig-alt="Viser tjenestekonfigurasjonen i Dapla Lab." #fig-dapla-lab-jdemetra-konf-service}


@fig-dapla-lab-jdemetra-konf-ressurser-diskplass viser neddtrekksmenyen for ressurser og diskplass, hvor man kan velge antall CPU-kjerner, minne og diskplass.
