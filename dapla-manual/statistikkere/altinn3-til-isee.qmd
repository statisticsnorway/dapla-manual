...
::: panel-tabset
## Image 1
![](../images/images/altinn3-isee-kilde-transfer-1.png){width=80%}

## Image 2
![](../images/images/altinn3-isee-kilde-transfer-2.png){width=80%}

## Image 3
![](../images/images/altinn3-isee-kilde-transfer-3.png){width=80%}

## Image 4
![](../images/images/altinn3-isee-kilde-transfer-4.png){width=80%}

## Image 5
![](../images/images/altinn3-isee-kilde-transfer-5.png){width=80%}
:::
...
I første omgang holder vi det enkelt og setter opp rammen som vi senere skal fylle ut. Vi kommer tilbake til mapping senere, hvis du er utålmodig kan du hoppe til steg 8 og gå løs på det nå.
...
Tilpasningen du selv må gjøre er å endre filstiene og fylle ut mapping.

Filstiene må du endre nå, mappingen kan du utsette til du er ferdig med å sette opp overføringene. Det er vanskelig å sjekke om mappingen din stemmer uten å ha forsøkt innlasting til ISEE, så det kan være greit å ordne resten av løpet først.

Hva er poenget med mapping?

Mapping brukes for å koble nytt variabelnavn til ISEE feltnavn og er nødvendig for at dataene dine skal bli synlige i ISEE.
