...
For å sette opp testløpet er det foreløpig nødvendig å kontakte kundeservice for å åpne på tilganger, slik at du kan overføre filer altinn-staging til prod teamet ditt. Til vanlig så har du kun tilgang til altinn-staging fra test-teamet, men siden test-teamet ikke kan overføre filer til bakken så er det ikke mulig å teste innlasting til ISEE med skjemaer fra tt02 uten denne tilgangen.
:::
