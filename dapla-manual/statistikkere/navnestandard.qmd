...
De to første mappenivåene er bestemt og oblikatoriske. Teamene kan likevel opprette egendefinerte mapper der det er behov. Det kan gjøres i følgende tilfeller:
...
![De ulike delene av et standardisert filnavn](../images/filename-breakdown.png){#fig-filename-breakdown width=600px}
...
| Versjon                               | Versjon av datasettet. I filnavnet må versjonsnummeret prefikses med “_v”, eksempel “v1”, “v2” eller “v3”. Se også eget kapittel om [versjonering av datasett](versjonering-av-datasett.qmd).                                                                                                                                                                    |
