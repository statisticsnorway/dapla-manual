...
Grunnen til at navnet på Jupyter-kernels ikke vises selv om den eksisterer, er en feil i hvor VS Code leter etter tilgjengelige kernels. Derfor må man inntil denne feilen er fikset må man derfor bruke `.venv`-installasjonen for å bruke pakkene i ditt ssb-project.
