...
::: {.hero-buttons}
[Kom i gang](statistikkere/index.qmd){.btn-action-primary .btn-action .btn .btn-lg role="button" style="margin-top: 1em; background: linear-gradient(90deg, #e40303 0%, #e40303 16.6%, #ff8c00 16.6%, #ff8c00 33.3%, #ffed00 33.3%, #ffed00 50%, #008026 50%, #008026 66.6%, #004dff 66.6%, #004dff 83.3%, #750787 83.3%, #750787 100%); border: none; color: white; text-shadow: 0 1px 3px rgba(0,0,0,0.35);"}
::: 
:::
