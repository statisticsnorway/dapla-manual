...
::: {.hero-buttons}
[Kom i gang](statistikkere/index.qmd){.btn-action-primary .btn-action .btn .btn-lg role="button" style="margin-top: 1em; background: linear-gradient(
90deg,
rgba(228,3,3,0.7) 0%,
rgba(228,3,3,0.7) 16.6%,
rgba(255,140,0,0.7) 16.6%,
rgba(255,140,0,0.7) 33.3%,
rgba(255,237,0,0.7) 33.3%,
rgba(255,237,0,0.7) 50%,
rgba(0,128,38,0.7) 50%,
rgba(0,128,38,0.7) 66.6%,
rgba(0,77,255,0.7) 66.6%,
rgba(0,77,255,0.7) 83.3%,
rgba(117,7,135,0.7) 83.3%,
rgba(117,7,135,0.7) 100%
); border: none; color:rgb(255, 255, 255); font-family: sans-serif; font-weight: bold;text-shadow: 0 1px 3px rgba(0,0,0,1);"}
::: 
:::
