...
6. Under **Expiration** velger du hvor lang tid som skal gå før PAT blir ugyldig. Dette er en avvening mellom sikkerhet og hva som er praktisk. Det anbefalet at velger **365 dager**. Når PAT utløper må du gjenta stegene i dette kapitlet.
...
**GitHub-bruker** er da din personlige bruker og IKKE brukernavnet ditt i SSB. **Personal Access Token** er det vi lagde forrige kapitel.
