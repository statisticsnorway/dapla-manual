...
Denne informasjonen brukes av Git hver gang du *commiter* en endring inn i koden, slik at man kan vite hvem som gjorde endringen senere. Dette må settes en gang per miljø du skal jobbe med Git. Hvis du f.eks. jobber i **Jupyterlab** på **Dapla** så kan du åpne en terminal og skrive følgende for lagre ditt brukernavn:
