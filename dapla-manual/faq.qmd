...
I dapla-buckets med objektversjonering aktivert, blir overskrevne og slettede filer noncurrent.

En noncurrent versjon blir slettet hvis den er mer enn **180 dager gammel og det er minst 2+ eller 3+ nyere versjoner i bøtta**.

(2+ for produktbøtte og 3+ for kildebøtte)

Non-dapla bøtter eller i managed team, bøtter er ikke versjonert. I så fall endres slettede/overskrevne filer fra live til soft-deleted. soft-deleted filer har en retention-duration på 7 dager. Etter 7 dager vil alle soft-deleted versjoner av en fil som er mer enn 7 dager gammel, bli slettet.
